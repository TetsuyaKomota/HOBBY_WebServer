var TalkRoom = React.createClass(
    {
        ...
        handleLogin : function(e){
            ...
            $.ajax({
                url: 'http://ec2-13-113-21-149.ap-northeast-1.compute.amazonaws.com/api/hikari_login',
                type: 'POST',
                scriptCharset: 'UTF-8',
                data: {
        ...
        handleCreateUser : function(e){
            ...
            $.ajax({
                url: 'http://ec2-13-113-21-149.ap-northeast-1.compute.amazonaws.com/api/hikari_create_user',
                type: 'POST',
                scriptCharset: 'UTF-8',
                data: {
        ...
        checkValidation : function(target){
            ...
            if(date.getTime() - this.state.last_input < this.state.delay){
                ...
                $.ajax({
                url: 'http://ec2-13-113-21-149.ap-northeast-1.compute.amazonaws.com/api/hikari_user_validation',
                type: 'POST',
                scriptCharset: 'UTF-8',
                data: {
